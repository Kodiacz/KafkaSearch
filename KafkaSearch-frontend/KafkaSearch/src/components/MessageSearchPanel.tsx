...
const MessageSearchPanel = () => {
  ...
  return (
    ...
    >
        ...
        <NumberField label="Max Results" min={1} max={50_000} onChange={handleMaxResultsChange} value={maxResults} />
        <TextField label="Quick Search" variant="outlined" placeholder="Search messages..." />
    </Paper>
  );
};
